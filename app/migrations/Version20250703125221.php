 ...
 */
final class Version20250703125221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE addresses CHANGE users_id users_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE addresses CHANGE users_id users_id INT DEFAULT NULL
        SQL);
        $this->addSql(<<<'SQL'
